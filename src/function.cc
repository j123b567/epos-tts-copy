...
next:		if (++mult > cfg->hash_search)
		...
		DEBUG(1,0, fprintf(STDDBG, "%set of %d characters sized %d items, mult is %d\n",
...
next:		if (++mult > cfg->hash_search)
		...
		DEBUG(1,0, fprintf(STDDBG, "Function for %d characters sized %d items, mult is %d\n",
				strlen(s), size, mult);)
